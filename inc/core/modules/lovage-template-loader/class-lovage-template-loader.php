 ...
 *
 * @package   Lovage_Pro_Template_Loader
 * @author    Gary Jones
 ...
 * @version   1.2.0
 */
if ( ! class_exists( 'Lovage_Template_Loader' ) ) {
	/**
	 * Template loader.
	 *
	...
	class Lovage_Template_Loader {
		 ...
		 * @var string
		 */
		protected $filter_prefix = 'lovage_';
		/**
		 ...
		 * @var string
		 */
		protected $theme_template_directory = 'lovage-templates';
		/**
