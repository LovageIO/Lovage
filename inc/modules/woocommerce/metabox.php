...
function save_lovage_taxonomy_custom_meta( $term_id ) {
...
add_action( 'edited_product_cat', 'save_lovage_taxonomy_custom_meta', 10, 2 );  
add_action( 'create_product_cat', 'save_lovage_taxonomy_custom_meta', 10, 2 );
